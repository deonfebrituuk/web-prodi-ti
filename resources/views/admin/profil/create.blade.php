        ...
        <div class="card-body">
          ...
          <form class="row g-3 "  method="POST" action="{{ route('data-profil.store') }}" enctype="multipart/form-data">
           ...
           <div class="col-12">
            ...
            <div class="col-md-12">
              <div class="form-floating">
                <input name="ig" value="{{ old('ig') }}" type="text" class="form-control" id="floatingName" placeholder="Nama Mahasiswa">
            ...
            <div class="col-md-12">
              <div class="form-floating">
                <input name="fb" value="{{ old('fb') }}" type="text" class="form-control" id="floatingName" placeholder="Nama Mahasiswa">
            ...
            <div class="col-md-12">
              <div class="form-floating">
                <input name="linkedin" value="{{ old('linkedin') }}" type="text" class="form-control" id="floatingName" placeholder="Nama Mahasiswa">
