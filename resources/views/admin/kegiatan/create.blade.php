    ...
    <div class="col-lg-8">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form class="row g-3 "  method="POST" action="{{ route('data-kegiatan.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="col-md-12">
              <div class="form-floating">
                <input name="judul" value="{{ old('judul') }}" type="text" class="form-control" id="floatingName" placeholder="Nama Mahasiswa">
