            ...
            <div class="container px-lg-5">
                <div class="row g-5">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <p class="mb-4">
                            <?php echo e($tentang->deskripsi); ?>

                        </p>
                        
                        <div class="d-flex align-items-center mt-4">
                            <a class="btn btn-primary rounded-pill px-4 me-3" href="<?php echo e(route('profil')); ?>">Read More</a>
                            <a class="btn btn-outline-primary btn-square me-3" href="https://web.facebook.com/<?php echo e($profil->fb); ?>"><i class="fab fa-facebook-f"></i></a>
                            
                            <a class="btn btn-outline-primary btn-square me-3" href="https://www.instagram.com/<?php echo e($profil->ig); ?>"><i class="fab fa-instagram"></i></a>
                            <a class="btn btn-outline-primary btn-square" href="https://linkedin.com/in/<?php echo e($profil->linkedin); ?>"><i class="fab fa-linkedin-in"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <img class="img-fluid wow zoomIn" data-wow-delay="1.5s" src="<?php echo e(asset('/landPage/img/about.jpg')); ?>">
                    </div>
                </div>
            </div>
        </div>
...
</html><?php /**PATH D:\xampp\htdocs\SI_TI\resources\views/landingPage/home.blade.php ENDPATH**/ ?>