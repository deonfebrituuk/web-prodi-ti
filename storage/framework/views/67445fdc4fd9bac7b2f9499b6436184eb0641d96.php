          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title"><?php echo e($title); ?> - 
                  <a href="<?php echo e(route('data-dosen.create')); ?>" class="btn btn-success">
                ...
                <tbody>
                  <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                      <tr>
                        ...
                        <th scope="row">
                          <form action="<?php echo e(route('data-dosen.destroy', $item->id)); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('delete'); ?>
                            <a href="<?php echo e(route('data-dosen.edit', $item->id)); ?>" class="btn btn-warning">
                        ...
                        <td>
                          ...
                          <?php echo e($item->ttl); ?> <br>
                          <?php echo e($item->email); ?> <br>
                          
                          <i class="bi bi-whatsapp"></i>
                          <a href="https://wa.me/<?php echo e($item->wa); ?>"><?php echo e($item->wa); ?></a> <br>
...
<?php echo $__env->make('admin.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\SI_TI\resources\views/admin/dosen/index.blade.php ENDPATH**/ ?>