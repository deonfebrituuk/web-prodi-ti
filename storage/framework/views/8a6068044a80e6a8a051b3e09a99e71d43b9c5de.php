...
<body>
  <?php $__env->startSection('page-title', 'login page'); ?>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form method="POST" action="<?php echo e(route('login.post')); ?>" class="row g-3 needs-validation" novalidate>
                    <?php echo csrf_field(); ?>
                    <div class="col-12">
...
</html><?php /**PATH D:\xampp\htdocs\SI_TI\resources\views/admin/login.blade.php ENDPATH**/ ?>